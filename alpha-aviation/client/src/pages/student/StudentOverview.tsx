            ...
            {receiptUploaded ? (
              ...
              >
                ...
                <p className="text-xs text-green-700">
                  Our team will verify your payment shortly. You'll receive a
              ...
              <div className="space-y-4">
                ...
                <p className="text-xs text-slate-500 text-center">
                  After completing your bank transfer, upload the receipt here
                  for verification.
                </p>
              </div>
            )}
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-white">
                          Please complete your payment to continue your training
                          program.
                        </p>
                      </div>
                    </div>
